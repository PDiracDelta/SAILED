...
Data analysis of isobaric labeling experiments is a complex process which consists of multiple steps. Each of these steps require careful consideration, otherwise the success of the whole study may be at risk. In this series of notebooks we decided to check the impact of four analysis components on the end results of a quantitative proteomic study. These components are: unit, summarization, normalization and differential expression analysis.      
