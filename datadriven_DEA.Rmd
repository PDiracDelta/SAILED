...
n.comp.variants <- 2
variant.names <- c('LIMMA', 'Wilcoxon')
scale.vec <- c('log', 'log') 
...
TO DO:-Wilcoxon test doesn't compute log2FC. Wanna try to compute means on original scale and then log2 ratio of sample means?
