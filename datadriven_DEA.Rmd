...
cvplot_ils(dat=dat.norm.summ.l, feature.group='Protein', xaxis.group='Condition', title='Normalized')
par(mfrow=c(1, 1))  
```
...
scatterplot_ils(dat.dea[c('LIMMA', 'Wilcoxon')], logFC.cols, 'log2FC', spiked.proteins)
```
...
violinplot_ils(lapply(dat.dea[c('LIMMA', 'Wilcoxon')], function(x) x[spiked.proteins, logFC.cols]), referenceCondition)
```
