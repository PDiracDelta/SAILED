...
variant.names <- c('LMM1', 'DEqMS', 'ANOVA_protein', 'ANOVA_PSM')
...
Peptidestat %>% filter(PeptidecountMin>4)
```
...
```{r}
dat.dea <- readRDS('modelbased_datdea_nowarnings.rds')
...
```{r, results='asis'}
#saveRDS(dat.dea, 'modelbased_datdea_nowarnings.rds')
