...
<!-- ## mixed model (intra-protein correlation modeled with 1|Run:Channel:Peptide) -->

# ```{r}
# dat.dea$LMM3 <- lmm_dea(dat=dat.norm.l, mod.formula='response ~ Condition + (1|Run:Channel:Peptide)', referenceCondition) 
# ```
