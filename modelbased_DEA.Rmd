...
```{r}
medianlineplot_ils(dat.summ.l, 'Before normalization')
medianlineplot_ils(dat.norm.l, 'After normalization')
```
...
dat.norm.l <- dat.norm.l %>% filter(!(Condition %in% referenceChannels)) %>% droplevels
