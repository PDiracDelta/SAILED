...
p1 <- maplot_ils(dat.summplot.w, 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', 'Before normalization', spiked.proteins)
p2 <- maplot_ils(dat.normplot.w, 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', 'After normalization', spiked.proteins)
...
p1 <- maplot_ils(dat.summplot.w, samples.num, samples.denom, scale='log', 'Before normalization', spiked.proteins)
p2 <- maplot_ils(dat.normplot.w, samples.num, samples.denom, scale='log', 'After normalization', spiked.proteins)
grid.arrange(p1, p2, ncol=2)  
```
