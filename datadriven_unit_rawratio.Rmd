...
scale.vec <- c('log', 'raw', 'raw','raw','raw','raw', 'raw','raw')  # ratios are considered raw, because they are basically mean-normalized intensities
...
*ratio_onetag*: divide by one channel reserved for the reference condition (here the first channel of `r referenceCondition`)
```{r}
