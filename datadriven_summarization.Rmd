...
```{r}
for (i in 1:n.comp.variants){
  p1 <- maplot_ils(dat.nonnorm.summ.w2[[variant.names[i]]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale.vec, paste('Raw', variant.names[i], sep='_'), spiked.proteins)
  p2 <- maplot_ils(dat.norm.summ.w2[[variant.names[i]]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale.vec, paste('Normalized', variant.names[i], sep='_'), spiked.proteins)
...
save(dat.nonnorm.summ.l
     ...
     ,dat.nonnorm.summ.w2
     ,dat.norm.summ.w2
     ,dat.dea, file='datadriven_summarization_outdata.rda')
```
