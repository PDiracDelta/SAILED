...
p[[1]] <- maplot_ils(dat.nonnorm.summ.w2, ma.onesample.num, 'Mixture1_2:129N', scale.vec, 'raw', spiked.proteins)
for (i in 1: n.comp.variants){
 p[[i+1]]<- maplot_ils(dat.norm.summ.w2[[variant.names[i]]], ma.onesample.num, 'Mixture1_2:129N', scale.vec, paste('normalized', variant.names[i], sep='_'), spiked.proteins)}
