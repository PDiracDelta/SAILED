...
medianlineplot_ils(dat.nonnorm.summ.l[[1]], paste('Before normalization', variant.names[i], sep='_'))
for (i in 1:n.comp.variants){
  medianlineplot_ils(dat.norm.summ.l[[i]], paste('After normalization', variant.names[i], sep='_'))}
```
...
dat.nonnorm.summ.w2 <- dat.nonnorm.summ.w2 %>% select(-one_of(chr))
