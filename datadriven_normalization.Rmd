...
## Scatter plots
TO DO: Piotr: constant NOMAD i RAW p-values (approx. 1) generate error in scatterplots
```{r}
...
#scatterplot_ils(dat.dea, p.cols, 'p-values') # commented due to error, sd=0 for NOMAD and RAW
