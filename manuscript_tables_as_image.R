...
keep_objects=c('referenceCondition', 'reportContrast', 'condition.color', 'spiked.proteins','sample.info', 'channelNames','op','keep_objects')

# Note that pdfs with confusion matrices are saved in the current working directory
