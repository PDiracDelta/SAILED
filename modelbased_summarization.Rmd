...
for (i in 1: n.comp.variants){
  p1 <- maplot_ils(dat.summplot.w[[i]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', paste('Before normalization', variant.names[i], sep='_'))
  p2 <- maplot_ils(dat.normplot.w[[i]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', paste('After normalization', variant.names[i], sep='_'))
...
for (i in 1: n.comp.variants){
  p1 <- maplot_ils(dat.summplot.w[[i]], samples.num, samples.denom, scale='log', paste('Before normalization', variant.names[i], sep='_'))
  p2 <- maplot_ils(dat.normplot.w[[i]], samples.num, samples.denom, scale='log', paste('After normalization', variant.names[i], sep='_'))
  grid.arrange(p1, p2, ncol=2)}
```
