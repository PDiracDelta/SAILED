...
```{r}
dat.summ.l$median_summ <- aggFunc(dat.unit.l, 'response', 'median')
```

## PSM to peptide summarization using sum

```{r}
dat.summ.l$sum_summ <- aggFunc(dat.unit.l, 'response', 'sum')
```
...
dat.summplot.l$no_summ <- aggFunc(dat.summ.l$no_summ, 'response', 'mean') # only first variant requires aggregation to peptide level

# after normalization
dat.normplot.l <- dat.norm.l
dat.normplot.l$no_summ <- aggFunc(dat.norm.l$no_summ, 'response', 'mean') # only first variant requires aggregation to peptide level
