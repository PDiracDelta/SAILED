...
for (i in 1: n.comp.variants){
  p1 <- maplot.ils(dat.summplot.w[[i]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', paste('Before normalization', variant.names[i], sep='_'))
  p2 <- maplot.ils(dat.normplot.w[[i]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', paste('After normalization', variant.names[i], sep='_'))
...
for (i in 1: n.comp.variants){
  p1 <- maplot.ils(dat.summplot.w[[i]], samples.num, samples.denom, scale='log', paste('Before normalization', variant.names[i], sep='_'))
  p2 <- maplot.ils(dat.normplot.w[[i]], samples.num, samples.denom, scale='log', paste('After normalization', variant.names[i], sep='_'))
  grid.arrange(p1, p2, ncol=2)}
```
...
par(mfrow=c(1, 2))
for (i in 1: n.comp.variants){
  cvplot.ils(dat=dat.summplot.l[[i]], feature.group='Peptide', xaxis.group='Condition', title=paste('Before normalization', variant.names[i], sep='_'), abs=F)
  cvplot.ils(dat=dat.normplot.l[[i]], feature.group='Peptide', xaxis.group='Condition', title=paste('After normalization', variant.names[i], sep='_'), abs=F)}
par(mfrow=c(1, 1))
```
...
par(mfrow=c(1, 2))
for (i in 1: n.comp.variants){
  pcaplot.ils(dat.summplot.w[[i]], info=sample.info, paste('Before normalization', variant.names[i], sep='_'), scale=T)
  pcaplot.ils(dat.normplot.w[[i]], info=sample.info, paste('After normalization', variant.names[i], sep='_'))}
par(mfrow=c(1, 1))
```
...
par(mfrow=c(1, 2))
for (i in 1: n.comp.variants){
  dendrogram.ils(dat.summplot.w[[i]], info=sample.info, paste('Before normalization', variant.names[i], sep='_'))
