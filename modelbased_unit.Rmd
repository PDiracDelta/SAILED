...
par(mfrow=c(1,2))
for (i in 1: n.comp.variants){
  cvplot_ils(dat=dat.summplot.l[[i]], feature.group='Peptide', xaxis.group='Condition', title=paste('Before normalization', variant.names[i], sep='_'), abs=F)
  cvplot_ils(dat=dat.normplot.l[[i]], feature.group='Peptide', xaxis.group='Condition', title=paste('After normalization', variant.names[i], sep='_'), abs=F)}
par(mfrow=c(1,1))
```
