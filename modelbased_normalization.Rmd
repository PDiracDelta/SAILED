...
p[[1]] <- maplot_ils(dat.summplot.w, 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', 'Before normalization', spiked.proteins)
for (i in 1: n.comp.variants){
  p[[i+1]] <- maplot_ils(dat.normplot.w[[i]], 'Mixture2_1:127C', 'Mixture1_2:129N', scale='log', paste('After normalization', variant.names[i], sep='_'), spiked.proteins)}
...
p <- emptyList(c('raw', names(dat.normplot.w)))
p[[1]] <- maplot_ils(dat.summplot.w, samples.num, samples.denom, scale='log', 'Before normalization', spiked.proteins)
for (i in 1: n.comp.variants){
  p[[i+1]] <- maplot_ils(dat.normplot.w[[i]], samples.num, samples.denom, scale='log', paste('After normalization', variant.names[i], sep='_'), spiked.proteins) }
grid.arrange(grobs = p, ncol=2, nrow=2)
```
