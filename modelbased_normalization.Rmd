...
for (i in 1: n.comp.variants){
  pcaplot_ils(dat.normplot.w[[i]][rownames(dat.summplot.w) %in% spiked.proteins, ], info=sample.info, paste('Normalized', variant.names[i], sep='_'))}
par(mfrow=c(1, 1))
```
...
pcaplot_ils(dat.summplot.w[rownames(dat.summplot.w) %in% spiked.proteins, ], info=sample.info, 'Raw', scale=T)
for (i in 1: n.comp.variants){
    pcaplot_ils(dat.normplot.wgt.w[[i]][rownames(dat.normplot.wgt.w[[1]]) %in% spiked.proteins, ], info=sample.info, paste('Normalized', variant.names[i], sep='_'))}
par(mfrow=c(1, 1))
```
