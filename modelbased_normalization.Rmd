...
```{r}
par(mfrow=c(2,2))
pcaplot.ils(dat.summplot.w, info=sample.info, 
            'Before normalization', scale=T)
for (i in 1: n.comp.variants){
  pcaplot.ils(dat.normplot.w[[i]], info=sample.info, 
...
```{r}
par(mfrow=c(2,2))
dendrogram.ils(dat.summplot.w, info=sample.info, 
               'Before normalization')
for (i in 1: n.comp.variants){
  dendrogram.ils(dat.normplot.w[[i]], info=sample.info, 
                 paste('After normalization', variant.names[i], sep='_'))}
par(mfrow=c(1, 1))
```
